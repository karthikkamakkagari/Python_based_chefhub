...
ROOT_URLCONF = 'CateringPro_Management_Suite.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [BASE_DIR / "templates"],   # <-- make sure your templates folder is included
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'CateringPro_Management_Suite.wsgi.application'
